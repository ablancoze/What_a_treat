 ...
 */
@WebServlet(description = "Servlet para lanzar la pagina de inicio de la app de chollos", urlPatterns = { "/WhatAtreatSearch" })
public class WhatAtreatSearch extends HttpServlet {
