...
/**
 * Servlet implementation class WhatAtreatShops
 */
@WebServlet(description = "Servlet para lanzar la pagina de inicio de la app de chollos", urlPatterns = { "/WhatAtreatShops" })
public class WhatAtreatShops extends HttpServlet {
...
logger.info("Handling GET");
		...
		List<Chollo> cholloList = cholloDAO.getAllBySearchShop(Long.parseLong(request.getParameter("shopSerch")));
